...
class SIDStreamingDataset(IterableDataset):
    def __init__(self, hf_dataset, transform=None, max_per_class=1000):
...
sid_train = SIDStreamingDataset(hf_dataset = train_sid, transform=transform, max_per_class=1000)
sid_val = SIDStreamingDataset(hf_dataset = val_sid, transform=transform, max_per_class=1000)
...
class CIFAKEDataset(Dataset):
    def __init__(self, cifake_dataset, indices, transform=None):
...
cifake_train = CIFAKEDataset(train_cifake, cifake_indices, transform=transform)
cifake_val = CIFAKEDataset(test_cifake, indices=None, transform=transform)
